...
def add_cardinality_constraint(variables: List, constraint : int):
    print("lol")

def sat_solver():
    global var_count; global class_ref; global section_ref;
    ...
    with open('classes.csv', encoding='utf-8-sig') as classes_file:
        ...
        for class_desc in classes_list:
            ...
            class_ref[class_temp.subject + " " + class_temp.class_id] = class_temp
    with open('sections.csv', encoding='utf-8-sig') as sections_file:
        ...
        for sections_desc in sections_list:
            ...
            section_ref[section_temp.section_id] = section_temp
            var_count += 1
